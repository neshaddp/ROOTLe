...
public:
  ...
  //Added by JP, 05/12/2016
  Double_t GetZeroCrossingImprovedRMD(std::vector <Double_t> &,Int_t &,Double_t&); ///<Extracts zero-crossing CFD with a different search algorithm, better suited for slow signals 
