...
#define UPPER15BITMASK     0x7FFF0000  // Upper 15 bits
...
#define MODIDENTIFIER      0x0F0E00FA //Module idenfier (250 MHz, 14-bit, revision F) - JP, March 2016
...
public:
  ...
  /* An external clock may be used */ // JP 01/21/2016
  UInt_t exclocklow;             ///< portion of of external clock: bits 0-15
  UInt_t exclockhigh;             ///< portion of of external clock: bits 16-31            
  Double_t exclock;                ///< external clock


  bool has_esum=false;
  bool has_qdc=false;
  bool has_exclock=false;
  ...
  void SetExClockLow(UInt_t data);
  void SetExClockHigh(UInt_t data);
  void SetExClock();
